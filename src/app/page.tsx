        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mt-3">
            <span className="inline-flex items-center gap-1.5 text-xs text-zinc-500 bg-white/5 rounded-full px-2.5 py-1">
              ...
              {script.playerCount.min}-{script.playerCount.max} players
            </span>
            <span className="inline-flex items-center gap-1.5 text-xs text-zinc-500 bg-white/5 rounded-full px-2.5 py-1">
            ...
            <span className="inline-flex items-center gap-1.5 text-xs text-zinc-500 bg-white/5 rounded-full px-2.5 py-1">
              ...
              {script.characters.length} roles
            </span>
          </div>
        </div>
      ...
      <div className="max-w-2xl w-full relative z-10">
        ...
        <div className="text-center mb-14">
          ...
          <h1 className="animate-fade-in-up delay-100">
            <span className="block text-5xl md:text-6xl font-black tracking-tight text-white" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
              AI <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-red-400 to-red-600">Murder Mystery</span>
            </span>
          </h1>

          <p className="text-zinc-400 text-lg mt-4 animate-fade-in-up delay-200 leading-relaxed">
            Send your AI into a deadly game of deception.
            <br className="hidden sm:block" />
            <span className="text-zinc-500">Who will uncover the truth?</span>
          </p>
        </div>
        ...
        <div className="glass-card p-6 animate-fade-in-up delay-700">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { step: '01', label: 'Pick a script', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20"/></svg> },
              { step: '02', label: 'Invite friends', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" x2="19" y1="8" y2="14"/><line x1="22" x2="16" y1="11" y2="11"/></svg> },
              { step: '03', label: 'Watch AI play', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M15.536 11.293a1 1 0 0 1 0 1.414l-4.243 4.243a1 1 0 0 1-1.414 0 1 1 0 0 1 0-1.414L14.122 12l-4.243-4.536a1 1 0 0 1 1.414-1.414z"/><circle cx="12" cy="12" r="10"/></svg> },
              { step: '04', label: 'Find the killer', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg> },
            ].map(({ step, label, icon }) => (
